...
0 1.215366648 0.786669544 0.220128004 0.2 0.2 0.2
  #_no additional input for selected M option; read 1P per morph
#
1 # GrowthModel: 1=vonBert with L1&L2; 2=Richards with L1&L2; 3=age_specific_K_incr; 4=age_specific_K_decr; 5=age_specific_K_each; 6=NA; 7=NA; 8=growth cessation
1 #_Age(post-settlement)_for_L1;linear growth below this
5 #_Growth_Age_for_L2 (999 to use as Linf)
...
0 0.017940741 0.1552 0.413601852 0.687724074 0.858724074 1
1 #_First_Mature_Age
...
# Sex: 1  BioPattern: 1  NatMort
 0.01 1 0.3 0.1 0.8 0 2 0 0 0 0 0 0 0 # NatM_p_1_Fem_GP_1
# Sex: 1  BioPattern: 1  Growth
 -10 45 33 33 10 6 -2 0 0 0 0 0 0 0 # L_at_Amin_Fem_GP_1
 50 150 123 123 10 6 4 0 0 0 0 0 0 0 # L_at_Amax_Fem_GP_1
 0.05 0.25 0.147282 0.15 0.8 6 3 0 0 0 0 0 0 0 # VonBert_K_Fem_GP_1
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
            1             31          8             5.67            5             3          1          0          0          0          0          0          0          0 # SR_LN(R0)
           0.1             1          0.99           0.5          0.3             0         -4          0          0          0          0          0          0          0 # SR_BH_steep
             0             2          0.5           0.8           0.8             0         -99         0          0          0          0          0          0          0 # SR_sigmaR
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
            0.00001      0.5        0.0707          0.01           0.1             0        -99          0          0          0          0          0          0          0  #  LnQ_base_SURVEY1
            0.00001      0.5       0.07783          0.01           0.1             0         -4          0          0          0          0          0          0          0  #  LnQ_base_SURVEY2
...
# 3   SURVEY2 LenSelex
# 1   FISHERY1 AgeSelex
			0.001		   4             1         	   1             0.5           0          3          0          0          0          0          0          0          0  #  AgeSel_P1_FISHERY1(1)
            0.001          5             3             0             3             0          3          0          0          0          0          0          0          0  #  AgeSel_P2_FISHERY1(1)
# 2   SURVEY1 AgeSelex
...
# 3   SURVEY2 AgeSelex
#LO  Hi    Init  Prior  Pr_sd  Pr_type  Phase  env-var  use_dev  dev_mnyr  dev_mxyr  dev_ph  Block  Blk_fxn
         0.001			  4             0.5         	   1             0.5           0          3          0          0          0          0          0          0          0  #  AgeSel_P1_FISHERY1(1)
         0.001            5             3                  0             3             0         3          0          0          0          0          0          0          0  #  AgeSel_P2_FISHERY1(1)
